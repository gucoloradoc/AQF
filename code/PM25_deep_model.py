...
sys.stdout = open(out_path+'/console_output_' + tar_pollutant+'.txt', 'w')
...
plt.plot(epochs, np.log(val_loss), 'b', label='Validation loss', color='orange')
...
plt.plot(epochs, val_acc, 'b', label='Validation $r^2$', color='orange')
...
plt.plot(epochs, val_rmse, 'b', label='Validation $RMSE$', color='orange')
plt.legend()
plt.savefig(out_path+'/Train_val_loss_acc_' + tar_pollutant+'.png', dpi=300)
#plt.show()
...
sys.stdout = open(out_path+'/training_metrics_' + tar_pollutant+'.txt', 'w')
...
plt.savefig(out_path+'/R2_test_' + tar_pollutant+'.png', dpi=300)
